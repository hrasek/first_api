function Add_gift() {
  document.getElementById("bezdietyOutput").innerHTML =
    "Hovězí vývar s domácími játrovými knedlíčky, nudlemi a zeleninou <br> Svíčková na smetaně s karlovarským knedlíkem, šlehačkou a brusinkami";
}
// function Bezlepku() {
